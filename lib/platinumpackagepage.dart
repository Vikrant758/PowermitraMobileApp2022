...
class  Platinumpackagepage extends StatefulWidget {
  const  Platinumpackagepage({Key? key}) : super(key: key);

  @override
  State< Platinumpackagepage> createState() => _PlatinumpackagepageState();
}

class _PlatinumpackagepageState extends State< Platinumpackagepage> {
